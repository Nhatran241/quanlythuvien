...
public class PanelEmployees extends javax.swing.JPanel implements MouseListener,PropertyChangeListener{
    ...
    public PanelEmployees() {
     ...
     public void loadEmployeeAll(){
        String[] header = {"Mã NV","Tên Nhân Viên","Số Điện Thoại","Địa Chỉ"};
        dtm = new DefaultTableModel(header,0);
        ArrayList<nhanvienDTO> arr = new ArrayList<nhanvienDTO>();
        arr = nhanvienBUS.getNhanVien();
        nhanvienDTO em = new nhanvienDTO();
        for(int i = 0; i < arr.size(); i++){
            em = arr.get(i);
            int manv =  em.getMaNV();
            String tennv = em.getTenNhanVien();
            String sdt = em.getSdt();
            String diachi = em.getDiaChi();
            Object[] row = {manv,tennv,sdt,diachi};
            dtm.addRow(row);
        }
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        String[] header = {"Mã NV","Tên Nhân Viên","Số Điện Thoại","Địa Chỉ"};
        dtmsearch = new DefaultTableModel(header,0);
        ArrayList<nhanvienDTO> nv = nhanvienBUS.timKiemNhanVien(jTextField1.getText());
        if(nv.size()!=0){
         
            for (int i = 0; i < nv.size(); i++) {
                 Object[] row = {nv.get(i).getMaNV(),nv.get(i).getTenNhanVien(),nv.get(i).getSdt(),nv.get(i).getDiaChi()};
