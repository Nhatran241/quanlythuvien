    ...
    private void setBackgroudSeclect(String select){
       for(ItemRoot itemRoot : menu) {
           if(!itemRoot.getNameItem().equalsIgnoreCase(select)) {
               itemRoot.getPn_Item().setBackground(new Color(0,255,153));
               itemRoot.getLb_Item().setBackground(new Color(0,255,153));
           } else {
               itemRoot.getLb_Item().setBackground(new Color(96, 100, 191));
               itemRoot.getPn_Item().setBackground(new Color(96, 100, 191));
           }
       }
    }
}
